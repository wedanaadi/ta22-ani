...
class exportSlip implements WithStyles, FromView, ShouldAutoSize, WithTitle
{
  ...
  {
    return 'Slip Gaji '.$this->dataparsing[0]->pegawai->nama_pegawai.' - di cetak pada '.date('Y-m-d');
  }

  public function view(): View
  {
    return view('exports.slip', [
      'data' => $this->dataparsing[0],
    ]);
  }
}
